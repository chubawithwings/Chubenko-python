...
f3 = open('f3','a',encoding='utf-8')
f3.write('\n')
print('Количество элементов первого и второго файлов: ', len(a1 + a2), ',\n Индекс первого минимально элемента первого файла:', f1_index, file=f3)
print('\nИндекс последнего максимального элемента второго файла:', f2_index, ',\n Элементы кратные 4 первого и второго файлов:', kratn, file=f3)
f3.close()
f3 = open('f3','r')
print(f3.read())
f3.close()